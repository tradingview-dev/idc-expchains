...
class SAUDIDataGenerator(DataGenerator):
    ...
    def generate(self) -> list[str]:
        url = 'https://www.saudiexchange.sa/wps/portal/saudiexchange/trading/participants-directory/issuer-directory/!ut/p/z1/lc_LDoIwEAXQb-EDzFzQ1rosCyqJPGqpYjeGhTEkWl0Yv190B75nN8m5k7nkqCbnm2u7by7tyTeHbt84vmWSI5oLFMpUEjoxVZzPkhApo3UfiExx6FzqIpoyqFVI7q88TMk6UGbjBZZQ4L_l8WYkvuddn0BbcSdJzAQiYDIELyoOLjx3eIAPT5qdp_PR2hptOpJBcAPgEs77/p0/IZ7_5A602H80OOMQC0604RU6VD10F2=CZ6_5A602H80OGSTA0QFSTBN9F10I5=NJgetCompanyListByMarknetAndSectors=/'
